class TemplateHandler():
  def __init__(self):
    self.labelmapper = {"OFF": "we had several words that rendered this offensive", "NOT": "we had no words that rendered this offensive, they are non-existent!"}
    self.explanation_filler = "they were"
